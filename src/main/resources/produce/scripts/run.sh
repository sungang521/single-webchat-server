...
GATEWAY_OPTS="-Dname=$dir -Dbase_path=$dir -Ddatadownthorough=xhw_data_down_thorough -Ddatadownthoroughtpartionnum=3 -Ddataupthorough=xhw_data_up_thorough -Ddataupthoroughtpartionnum=3 -Ddevicedataqueue=device_data_topic -Dtrashdataqueue=trash_data_topic -Ddevicefaultqueue=device_fault_topic -Ddeviceeventqueue=device_event_topic -Ddatareportpartionnum=3 -Dtrashreportpartionnum=3 -Deventreportpartionnum=3 -Dfaultreportpartionnum=3 -Dzkurl=192.168.1.3:2181,192.168.1.4:2181,192.168.1.5:2181 -Dsound.gateway.path=$dir/"
